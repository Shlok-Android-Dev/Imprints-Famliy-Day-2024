...
public class SelectDeviceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String deviceNames = "Via USB";
        String deviceHardwareAddresss = "VIA-USB"; // MAC address
        DeviceInfoModel deviceInfoModelvia = new DeviceInfoModel(deviceNames,deviceHardwareAddresss);
        deviceList.add(deviceInfoModelvia);
