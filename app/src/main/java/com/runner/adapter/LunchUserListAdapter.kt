...
class LunchUserListAdapter : RecyclerView.Adapter<LunchUserListAdapter.ViewHolder> {
    var context: Context
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        /*hide Add Guest on lunch User List Adapter*/
        ...
        if (isPrintList.get(position) == 1) {
            ...
            holder.print_status!!.background =
                context!!.getDrawable(R.drawable.round_corner_10_stroke_dots_line)
        ...
        if (email_list.get(position)
                .equals("") || email_list.get(position) == null || email_list.get(position)
                .equals("null")
        ) {
        ...
        if (designation_list.get(position)
                .equals("") || designation_list.get(position) == null || designation_list.get(
                position
            ).equals("null")
        ) {
        ...
        if (phone_list.get(position)
                .equals("") || phone_list.get(position) == null || phone_list.get(position)
                .equals("null")
        ) {
        ...
        if (category!!.get(position)
                .equals("") || category!!.get(position) == null || category!!.get(position)
                .equals("null")
        ) {
        ...
        if (!Registration_list!!.get(position).isEmpty() && !Registration_list!!.get(position).equals("null")) {
            ...
            guest_array  = JSONArray(Registration_list!!.get(position))
            var guest_array1 = JSONArray(Registration_list!!.get(position))
            ...
            for (i in 0 until guest_array.length()) {
                ...
                var listguest: ArrayList<String> = ArrayList<String>()
                ...
                Log.e("@@...",guest_array.getJSONObject(i).getString("is_lunch_allotted"))
                if(guest_array.getJSONObject(i).getString("is_lunch_allotted").equals("1",ignoreCase = true)){
                ...
                checkbox.setOnClickListener {
                    ...
                    if (checkbox.isChecked) {
                        listguest.add(guest_array.getJSONObject(i).getString("name"))
                        guest_array1.getJSONObject(i).put("is_lunch_allotted","1")


                    } else {
                        listguest.remove(guest_array.getJSONObject(i).getString("name"))
                        guest_array1.getJSONObject(i).put("is_lunch_allotted","0")
                    }

                    clicklistener.onGuestCheckboxClicked(listguest.toString(),position,guest_array1.toString())
        ...
        if (memberArray.length() > 0) {
            ...
            for (i in 0 until memberArray.length()) {
                ...
                if (memberArray.getJSONObject(i).has("is_lunch_allotted")) {

                    if (memberArray.getJSONObject(i).getInt("is_lunch_allotted") == 1) {
                        checkbox.isChecked = true
                        checkbox.isEnabled = false
                        count += 1
                    } else {
                ...
                checkbox.text = memberArray.getJSONObject(i).getString("relation").toUpperCase()
                    .replace("_", "") + " : " + WordUtils.capitalize(
                    memberArray.getJSONObject(i).getString("name")
                )
        ...
        if (count == memberArray.length()  &&  guest_count == guest_array.length()) {
        ...
        if (attending_on!!.get(position)
                .equals("") || attending_on!!.get(position) == null || attending_on!!.get(position)
                .equals("null")
        ) {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            ...
            ll_cashless_reddem =
                itemView.findViewById<View>(R.id.ll_cashless_reddem) as LinearLayout
    ...
    interface Clicklistener {
        ...
        fun onCheckboxClicked(list: String)
        fun onGuestCheckboxClicked(list: String,position: Int,guest_array1:String)
