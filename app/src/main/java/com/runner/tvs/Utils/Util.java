...
//要旋转的左上角相对中心点坐标
    ...
    public static String stampToDate(long timeMillis) {
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat( RuheApp.Companion.getInstance().getString(R.string.time_format));
    ...
    public static void Post(Runnable runnable) {
         RuheApp.Companion.getInstance().getHandler().post(runnable);
    }
    ...
    public static void ToastTextThread(final Context context, final String text) {
        /* RuheApp.Companion.getInstance().getHandler().post(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(context, text, Toast.LENGTH_SHORT).show();
            }
