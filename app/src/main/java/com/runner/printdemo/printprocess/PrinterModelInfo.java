...
public class PrinterModelInfo {
    ...
    private static final String[] PS_PT_E4 = {"W3_5", "W6", "W9", "W12", "W18", "HS_W6", "HS_W9", "HS_W12", "HS_W18"};
    ...
    public enum Model {
        ...
        PT_D410(PORTS_USB, PS_PT_E4),
        PT_D460BT(PORTS_BT_USB, PS_PT_E4),
        PT_D610BT(PORTS_BT_USB, PS_PT),
        PJ_822(PORTS_USB, PS_PJ, PS_PJ_US),
        PJ_823(PJ_822),
        PJ_862(PORTS_BT_USB_BLE, PS_PJ, PS_PJ_US),
        PJ_863(PJ_862),
        PJ_883(PORTS_NET_BT_USB_BLE, PS_PJ, PS_PJ_US);
