...
public class Activity_StartMenu extends Activity {
    ...
    private void init() {
        ...
        try {
            ...
            raw2file("RJ3230B_76mm.bin", R.raw.rj3230b_76mm);
            raw2file("RJ3230B_76mm44mm.bin", R.raw.rj3230b_76mm44mm);
            raw2file("RJ3250WB_76mm.bin", R.raw.rj3250wb_76mm);
            raw2file("RJ3250WB_76mm44mm.bin", R.raw.rj3250wb_76mm44mm);
    ...
    private void setPreferences() {
        ...
        if (sharedPreferences.getString("printerModel", "").equals("")) {
            ...
            editor.putString("numberOfAutoCutPages", Integer.toString(printerInfo.numberOfAutoCutPages));
    ...
    private String saveDataFromIntent(Intent intent) {
        ...
        try {
            ...
            String folder = getFilesDir().toString() + "/com.brother.ptouch.sdk/";
