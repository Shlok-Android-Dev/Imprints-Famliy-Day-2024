...
import com.runner.printdemo.printprocess.PdfPrint;
...
public class Activity_PrintPdf extends BaseActivity {
    ...
    public void printButtonOnClick() {
        ...
        V4PrinterThread printTread = new V4PrinterThread(this, pages, allPages);
        printTread.start();
    ...
    private class V4PrinterThread extends Thread {
        ...
        public void run() {
            ...
            switch (port) {
                ...
                case USB:
                    channel = Channel.newUsbChannel((UsbManager)context.getSystemService(Context.USB_SERVICE)); break;
                case NET:
