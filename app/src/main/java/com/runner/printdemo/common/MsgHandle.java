...
package com.runner.printdemo.common;
    ...
    public void handleMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case Common.MSG_DATA_SEND_START:
                mDialog.showStartMsgDialog(mContext.getString(R.string.progress_dialog_message_communication_start));
                break;
            case Common.MSG_TRANSFER_START:
                mDialog.showStartMsgDialog(mContext.getString(R.string.progress_dialog_message_transfer_start));
                break;
